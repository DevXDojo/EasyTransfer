    ...
    <div class="header-cluster">
      ...
      <div class="link-cluster">
        <button class="link-item shadow" @click="toggleSettings">
          <SvgIcon type="mdi" :path="mdiCog" size="1.5rem" /><span class="text">{{ t('header.settings') }}</span>
        </button>
        <a href="https://github.com/DevXDojo/EasyTransfer" class="link-item shadow github">
          <SvgIcon type="mdi" :path="mdiGithub" size="1.5rem" /><span class="text">{{ t('header.starOnGitHub') }}</span>
        </a>
      </div>
    </div>
  </header>
